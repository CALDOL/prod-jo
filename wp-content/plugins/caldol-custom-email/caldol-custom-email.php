...
function caldol_new_user_approve_approve_user_message($message, $user){
	...
	$approvalMessage = "<p>Your request to join the Junior Officer Forum has been approved!<br/><a href='https://juniorofficer.army.mil/wp-login.php'>Login Now!</a></p>";

	$approvalMessage .= "<p>You may find it helpful to take our <a href='https://www.surveymonkey.com/r/JOTerrainWalk'>digital terrain walk</a> (https://www.surveymonkey.com/r/JOTerrainWalk)  of the forums. This brief exercise will help you explore different parts of the forum and quickly get familiar with its content and capabilities.</p>";

	$approvalMessage .= "<p>As a reminder, your login name is: " . $user->user_login . "</p>";



	$approvalMessage .= "<p>Your password is set to what you chose when you registered. Please keep it secret and keep it safe!
	If you happen to forget your password, you can reset it on the <a href='https://juniorofficer.army.mil/wp-login.php?action=lostpassword'>Lost Password</a> page.<p>";

	$approvalMessage .= "<p>If you have any problems, questions, opinions, praise, comments, suggestions, please feel free to <a href='mailto:thomas.morel@usma.edu'>contact us</a> at any time.</p>";
